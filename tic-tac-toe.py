...
Button(ButtomFrame, text='REJOUER', bg='#FAFAFA', fg='#00BFA5', font=('Trebuchet MS', 11, 'bold'), relief=RAISED, bd=0, command=NouvellePartie).pack(fill=BOTH, expand=1, ipady=10)
